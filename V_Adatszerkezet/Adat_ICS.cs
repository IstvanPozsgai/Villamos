...
namespace Villamos.Villamos_Adatszerkezet
{
    ...
    public class Adat_ICS_Előterv 
    {
       public long ID { get; private set; }
        ...
        public Adat_ICS_Előterv(long iD, string azonosító, long jjavszám, long kMUkm, DateTime kMUdátum, string vizsgfok, DateTime vizsgdátumk, DateTime vizsgdátumv, long vizsgkm, long havikm, long vizsgsorszám, DateTime fudátum, long teljeskm, string ciklusrend, string v2végezte, long kövV2_sorszám, string kövV2, long kövV_sorszám, string kövV, bool törölt, string módosító, DateTime mikor, string honostelephely, long tervsorszám, double kerék_K1, double kerék_K2, double kerék_K3, double kerék_K4, double kerék_K5, double kerék_K6, double kerék_K7, double kerék_K8, double kerék_min, long v2V3Számláló)
        {
            ID = iD;
            Azonosító = azonosító;
            Jjavszám = jjavszám;

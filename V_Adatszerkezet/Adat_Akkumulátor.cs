...
namespace Villamos.Villamos_Adatszerkezet
{
    ...
    public class Adat_Akkumulátor_Napló
    {
        ...
        public Adat_Akkumulátor_Napló(string beépítve, string fajta, string gyártó, string gyáriszám, string típus, DateTime garancia, DateTime gyártásiidő, int státus, string megjegyzés, DateTime módosításdátuma, int kapacitás, string telephely, DateTime rögzítés, string rögzítő)
        {
            Beépítve = beépítve;
            Fajta = fajta;
            Gyártó = gyártó;

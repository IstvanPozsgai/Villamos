...
namespace Villamos.Villamos_Adatszerkezet
{
    public class Adat_Szatube_Csúsztatás
    {
        ...
        public Adat_Szatube_Csúsztatás(string törzsszám, DateTime kezdődátum, int státus)
        {
            Törzsszám = törzsszám;
            Kezdődátum = kezdődátum;
            Státus = státus;
        ...
        public Adat_Szatube_Csúsztatás(string törzsszám, DateTime kezdődátum, int státus, int kivettnap, string szabiok, string rögzítette, DateTime rögzítésdátum, DateTime kezdőidő, DateTime befejezőidő)
        {
            Szabiok = szabiok;
            Státus = státus;
            Rögzítette = rögzítette;

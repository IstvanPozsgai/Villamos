...
namespace Villamos.V_Ablakok._7_Gondnokság.Épület_takarítás
{
    public class Epulettakaritas_Takaritasi_Megrendelo_Excel
    {
        public void ExcelKeszit()
        {
            ...
            MyX.Sormagasság("1:1", 47);
            MyX.Sormagasság("2:2", 39);
            ...
            MyX.Sortörésseltöbbsorba_egyesített("c1");
            MyX.Sortörésseltöbbsorba("d2:k2");
            MyX.Sortörésseltöbbsorba_egyesített("l1");
            MyX.Sortörésseltöbbsorba_egyesített("m1");
            MyX.Sortörésseltöbbsorba_egyesített("n1");
            MyX.Sortörésseltöbbsorba_egyesített("o1");
            MyX.Sortörésseltöbbsorba_egyesített("p1");
            MyX.Sortörésseltöbbsorba_egyesített("r1");
            ...
            foreach (Adat_Épület_Takarítás_Osztály rekord in AdatokTakOsztály)
            {
                ...
                MyX.Igazít_vízszintes("b" + sor.ToString() + ":W" + sor.ToString(), "bal");
                MyX.Háttérszín("b" + sor.ToString() + ":W" + sor.ToString(), 13434828);
                MyX.Kiir(rekord.Osztály.Trim(), "b" + sor.ToString());
                MyX.Sormagasság(sor.ToString() + ":" + sor.ToString(), 20);
                ...
                foreach (Adat_Épület_Adattábla rekord1 in AdatokA)
                {
                    ...
                    MyX.Kiir("=RC[-3]*RC[-9]", "o" + sor.ToString());
                    MyX.Kiir("=RC[-3]*RC[-7]", "p" + sor.ToString());
                    MyX.Kiir("=RC[-3]*RC[-6]", "q" + sor.ToString());
                    MyX.Kiir("=SUM(RC[-3]:RC[-1])", "r" + sor.ToString());
            ...
            MyX.Betű("b" + sor.ToString() + ":n" + sor.ToString(), false, false, true);
            MyX.Egyesít(munkalap, "b" + sor.ToString() + ":n" + sor.ToString());
            MyX.Egyesít(munkalap, "o" + sor.ToString() + ":r" + sor.ToString());
            MyX.Kiir("=SUM(R[-" + (sor - 3).ToString() + "]C[3]:R[-1]C[3])", "o" + sor.ToString() + ":r" + sor.ToString());
            MyX.Rácsoz("b1:W" + sor.ToString());
            MyX.Sormagasság(sor.ToString() + ":" + sor.ToString(), 25);

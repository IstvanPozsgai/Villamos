        ...
        private void Excel_KimenetCAF()
        {
            try
            {
                ...
                foreach (Adat_KerékMérő rekord in Adatok)
                {
                    ...
                    MyX.Kiir($"#SZÁMD#{rekord.A_BKOPJ}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_KKOPJ}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_h}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_ATM_J}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_BETAJ}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_NYKMJ}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_n}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_n2}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_KIFUTJ}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_V_J}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_a}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_NYKVJ}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_QR_J}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_BKOPB}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_KKOPB}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_hb}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_ATM_B}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_BETAB}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_NYKMB}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_nb}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_n2b}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_KIFUTB}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_V_B}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_ab}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_NYKVB}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_QR_B}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_HATL_T}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_Vt1}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_Vt2}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_t}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_apb_J}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_apb_B}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_Vt1BKV}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_Vt2BKV}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_ATM_K}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_Rf_J}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_Rf_B}", MyF.Oszlopnév(i++) + sor);
                ...
                foreach (Adat_KerékMérő rekord in Adatok)
                {
                    ...
                    MyX.Kiir($"#SZÁMD#{rekord.A_QR_B}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_BETAB}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{(rekord.A_ATM_J - rekord.A_ATM_B)}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_HATL_T}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_Vt1}", MyF.Oszlopnév(i++) + sor);
                    MyX.Kiir($"#SZÁMD#{rekord.A_Vt1BKV}", MyF.Oszlopnév(i++) + sor);

...
namespace Villamos
{
...

    {
        ...
        public void SzolgálatatóMódosítás()
        {
            ...
            form.Add("SzerződésSzám", (new InputTextbox("Szerződés száma:", TakarítóCég.SzerződésSzám)).AddRule(null))
                .Add("IratEleje", (new InputTextbox("IratEleje", TakarítóCég.IratEleje)).AddRule(null))
                .Add("IratVége", (new InputTextbox("IratVége", TakarítóCég.IratVége)).AddRule(null))
                .Add("Aláíró", (new InputTextbox("Aláíró", TakarítóCég.Aláíró)).AddRule(null))

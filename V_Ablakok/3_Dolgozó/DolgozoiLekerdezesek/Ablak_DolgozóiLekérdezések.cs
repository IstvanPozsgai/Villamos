...
using Villamos.V_Ablakok._3_Dolgozó.DolgozoiLekerdezesek;
    ...
    public partial class Ablak_DolgozóiLekérdezések
    {
        ...
        private void BtnExcelkimenet_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string[] Telephelyek = Cmbtelephely.CheckedItems.OfType<string>().ToArray();

                DolgozoiLekerdezesek_Felepites_Uzemenkent_Excel ExceltGeneral = new DolgozoiLekerdezesek_Felepites_Uzemenkent_Excel();
                ExceltGeneral.ExcelKimenetetKeszit(fájlexc, Telephelyek, KézSzemélyes, KézKulcs, KézCsop, KézDolg, KézKulcs2);
        ...
        private void Command3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string[] Telephelyek = Cmbtelephely.CheckedItems.OfType<string>().ToArray();
                DolgozoiLekerdezesek_Felepites_Aktualis FelepitesAktualisGeneral = new DolgozoiLekerdezesek_Felepites_Aktualis();
                FelepitesAktualisGeneral.ExceltKeszit(fájlexc, Telephelyek, KézDolg, KézCsop);
        ...
        private void Excelbe_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string Valtozatlista = Változatoklist.Text.Trim();
                string[] Csoportlista_ = Csoportlista.Items.OfType<string>().ToArray();

                DolgozoiLekerdezesek_Alaplista DolgozoiAlaplistaExcel = new DolgozoiLekerdezesek_Alaplista();
                DolgozoiAlaplistaExcel.ExcelGeneral(fájlexc, Telephely, Valtozatlista, Csoportlista_, Kéz_Változatok, KézDolg);

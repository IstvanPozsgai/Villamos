...
namespace Villamos.V_Ablakok._3_Dolgozó.Szatube
{
    public class Szatube_EgyeniNyomtatas
    {
        ...
        public void EgyeniNyomtatas(string fájlexc, string CmbTelephely, int Adat_Évek, Kezelő_Kiegészítő_Jelenlétiív KézJelenléti, Kezelő_Kiegészítő_főkönyvtábla KézFő, Kezelő_Dolgozó_Alap KézDolgAlap, Kezelő_Szatube_Túlóra KézTúlóra, DataGridView Tábla)
        {
            string válasz;
            ...
            // logók beszúrása
            MyX.Kép_beillesztés(munkalap, "A1", Application.StartupPath + @"\Főmérnökség\adatok\BKV.png", 5, 5, 0.55208, 0.6304);
            MyX.Kép_beillesztés(munkalap, "A1", Application.StartupPath + @"\Főmérnökség\adatok\BKV.png", 490, 5, 0.55208, 0.6304);
            ...
            MyX.Vastagkeret(munkalap, "a5:g5");
            MyX.Vastagkeret(munkalap, "j5:p5");
            // táblázat rajzolás
            ...
            MyX.Vastagkeret(munkalap, "a6:g17");
            MyX.Rácsoz(munkalap, "j6:p17");
            MyX.Vastagkeret(munkalap, "j6:p17");
            ...
            for (int i = 20; i < 31; i++)
            {
                MyX.Egyesít(munkalap, "a" + i.ToString() + ":b" + i.ToString());
                MyX.Egyesít(munkalap, "d" + i.ToString() + ":g" + i.ToString());
                MyX.Egyesít(munkalap, "j" + i.ToString() + ":k" + i.ToString());
                MyX.Egyesít(munkalap, "m" + i.ToString() + ":p" + i.ToString());
            }

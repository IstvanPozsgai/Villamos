...
namespace Villamos.Villamos_Kezelők
{
    public class Kezelő_Belépés_Bejelentkezés
    {
        ...
        public Adat_Belépés_Bejelentkezés Egy_Adat(string hely, string jelszó, string szöveg)
        {

            Adat_Belépés_Bejelentkezés Adat = null;
        ...
        public void Rögzítés(string hely, string jelszó, Adat_Belépés_Bejelentkezés Adat)
        {
            try
            {
        ...
        /// <param name="jelszó"></param>
        /// <param name="Adat"></param>
        public void Törlés(string hely, string jelszó, Adat_Belépés_Bejelentkezés Adat)
        {
            try
            {
    ...
    public class Kezelő_Belépés_Jogosultságtábla
    {
        ...
        public void Rögzítés(string hely, string jelszó, Adat_Belépés_Jogosultságtábla Adat)
        {
            try
            {
        ...
        /// <param name="jelszó"></param>
        /// <param name="Adat"></param>
        public void Módosítás(string hely, string jelszó, Adat_Belépés_Jogosultságtábla Adat)
        {
            try
            {
        ...
        /// <param name="jelszó"></param>
        /// <param name="Adat"></param>
        public void Törlés(string hely, string jelszó, Adat_Belépés_Jogosultságtábla Adat)
        {
            try
            {
    ...
    public class Kezelő_Belépés_WinTábla
    {
        ...
        public void Rögzítés(string hely, string jelszó, Adat_Belépés_WinTábla Adat)
        {
            try
            {
        ...
        public void Módosítás(string hely, string jelszó, Adat_Belépés_WinTábla Adat)
        {
            try
            {
    ...
    public class Kezelő_Belépés_Verzió
    {
        ...
        public List<Adat_Belépés_Verzió> Lista_Adatok(string hely, string jelszó, string szöveg)
        {

    ...
    public class Kezelő_Kerék_Tábla
    {
        ...
        public void Rögzítés(List<Adat_Kerék_Tábla> Adatok)
        {
            try
            {
                ...
                foreach (Adat_Kerék_Tábla Adat in Adatok)
                {
                    string szöveg = $"INSERT INTO {táblanév} (kerékberendezés, kerékmegnevezés, kerékgyártásiszám, föléberendezés, azonosító, pozíció, objektumfajta, dátum) VALUES (";
        ...
        public void Törlés(List<string> Adatok)
        {
            try
            {
                ...
                {
                    string szöveg = $"DELETE FROM {táblanév} WHERE [kerékberendezés]='{Adat}'";
                    SzövegGY.Add(szöveg);
                }
                    ...
                    foreach (Adat_Kerék_Tábla Elem in AdatokBe)
                    {
                        ...
                        if (RégiBerszám != null)
                        {
                            Adat_Kerék_Tábla Adat = new Adat_Kerék_Tábla(
                                  ...
                                  RégiBerszám.Kerékmegnevezés,
                                  RégiBerszám.Kerékgyártásiszám,
                                  "_",
                                  "_",
                                  "_",
                                  RégiBerszám.Dátum,

...
namespace Villamos.Villamos.Kezelők
{
    ...
    public class Kezelő_Alap_egyéb
    { }
    public class Kezelő_Alap_Beolvasás
    {
        ...
        public void Rögzítés(string hely, string jelszó, Adat_Alap_Beolvasás Adat)
        {
        ...
        public void Módosítás(string hely, string jelszó, Adat_Alap_Beolvasás Adat)
        {
            try
            {
        ...
        /// <param name="jelszó"></param>
        /// <param name="Adat"></param>
        public void Törlés(string hely, string jelszó, Adat_Alap_Beolvasás Adat)
        {
            try
            {
                string szöveg = "UPDATE  tábla SET ";
